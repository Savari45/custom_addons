
{
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            ...
            # 'pos_receipt_extend/static/src/js/CustomOrderReceipt.js',
            # 'pos_receipt_extend/static/src/js/ReprintReceiptScreen.js',

        ],
        # 'point_of_sale.assets': [
        #     'pos_receipt_extend/static/src/js/pos_order_extend.js',
        #
        # ],
    },
