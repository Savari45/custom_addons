# -*- coding: utf-8 -*-
{
    "name": "Margin on POS Screen Display and Analysis in Odoo",
    "version": "18.0.0.0",
    "depends": ['base', 'point_of_sale'],
    
    "summary": "Margin calculation on POS Screen and backend Order based on product also shows on analysis report  pos margin order margin for pos order Product margin In POS point of sales margin orders POS Orders margin POS Profit Margin pos gross margin",
    "description": """
	...
	also shows margin on POS order line. 
    Calculate margin on percentage and fixed.Margin Analysis, Margin on Product, POS and Invoice
    product margin, pos margin, pos order margin, pos backend margin. POS forntend margin, POS touchscreen margin, point of sale margin. point of sale touchscreen margin, point of sale frontend margin.
...
affiche également la marge sur la ligne de commande POS. Calculer la marge sur le pourcentage et fixe. Analyse de marge, marge sur le produit, POS et facture
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            'bi_pos_screen_margin/static/src/js/pos_margin.js',
            'bi_pos_screen_margin/static/src/js/BiOrderWidget.js',
            'bi_pos_screen_margin/static/src/css/pos_margin.css',
            'bi_pos_screen_margin/static/src/xml/pos_margin.xml',
        ],
    },
    "auto_install": False,
    "installable": True,
